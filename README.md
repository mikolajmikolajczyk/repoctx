...
```sh
shasum -a 256 -c repoctx-0.5.0-x86_64-unknown-linux-gnu.tar.gz.sha256
tar xzf repoctx-0.5.0-x86_64-unknown-linux-gnu.tar.gz
sudo mv repoctx-0.5.0-x86_64-unknown-linux-gnu/repoctx /usr/local/bin/
```
...
```sh
cargo install --git https://github.com/mikolajmikolajczyk/repoctx --tag v0.5.0
```
