...
You should see `repoctx 0.3.0` (or newer) plus the `index`, `symbols`, `outline`, `definition`, `context`, `status`, `languages`, `hook`, and `gain` subcommands. Then head to [`quickstart.md`](quickstart.md).
