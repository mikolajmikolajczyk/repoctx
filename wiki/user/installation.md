...
You should see `repoctx 0.5.0` (or newer) plus the `index`, `symbols`, `outline`, `definition`, `context`, `status`, `languages`, `config`, `hook`, and `gain` subcommands. Then head to [`quickstart.md`](quickstart.md).
