...
You should see `repoctx 0.7.1` (or newer) plus the `index`, `symbols`, `outline`, `definition`, `context`, `status`, `languages`, `config`, `init`, `hook`, and `gain` subcommands. Then head to [`quickstart.md`](quickstart.md).
