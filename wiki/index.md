...
Skills (repoctx, ...) live under `.agents/skills/` — fetched by `scripts/skills-bootstrap.sh` from [llm_skills](https://github.com/mikolajmikolajczyk/llm_skills). Not in wiki because they're not docs, they're agent capabilities.
